...
function scene:create( event )
    ...
    local memoryPiece = {}
    memoryPiece[1] = display.newImageRect("image/기억의 방/색깔 있는 병 1.png", 384,408)
    memoryPiece[2] = display.newImageRect("image/기억의 방/색깔 있는 병 5.png", 384,408)
    memoryPiece[3] = display.newImageRect("image/기억의 방/색깔 있는 병 3.png", 384,408)
    memoryPiece[4] = display.newImageRect("image/기억의 방/색깔 있는 병 4.png", 384,408)


    for i=1,4 do
        memoryPiece[i].x, memoryPiece[i].y = display.contentWidth * 0.1 + 200 * i, display.contentHeight * 0.23
    end
    ...
    chatting = display.newText("응. 여기서 기억의 조각은 꿈을 만드는데 정말\n소중한 자원이거든.\n마치 다이아몬드만큼 귀하지.",display.contentWidth * 0.82,display.contentHeight,display.contentWidth, display.contentHeight * 0.75, "KyoboHandwriting2019.ttf")
	...
	local function click(event)
        chatting.alpha=0
        composer.removeScene( "talk10" )
        composer.setVariable("complete", true)
        composer.gotoScene("talk11")
	end
