...
function scene:create( event )
    ...
    chatting = display.newText("기억의 조각을 모두 되찾아야해",display.contentWidth * 0.82,display.contentHeight,display.contentWidth, display.contentHeight * 0.6, "KyoboHandwriting2019.ttf")
	...
	local function click(event)
        chatting.alpha=0
        composer.removeScene( "talk13" )
        composer.setVariable("complete", true)
        composer.gotoScene("talk14")
	end
