...
function scene:create( event )
    ...
    chatting = display.newText("기억의 조각들이 어디에 있는데?",display.contentWidth * 0.82,display.contentHeight,display.contentWidth, display.contentHeight * 0.6, "KyoboHandwriting2019.ttf")
	...
	local function click(event)
        chatting.alpha=0
        composer.removeScene( "talk14" )
        composer.setVariable("complete", true)
        composer.gotoScene("talk15")
	end
